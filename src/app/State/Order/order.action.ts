...
export const getOrderByIdRequest=createAction(
  '[Order] Get Order By Id Request', props<{orderId: any}>()
)
...
export const getOrderHistorySuccess=createAction(
  '[Order] Get Order History Success', props<{order: any}>()
)
...
export const getAllOrderSuccess=createAction(
  '[Order] Get all Order Success', props<{payload: any}>()
)
export const getAllOrderFailure= createAction(
  '[Order] Get all Order Failure', props<{error: any}>()
)
...
export const confirmedOrderSuccess=createAction(
  '[Order] Confirmed Order Success', props<{payload: any}>()
)
export const confirmedOrderFailure= createAction(
  '[Order] Confirmed Order Failure', props<{error: any}>()
)
export const placeOrderRequest=createAction(
  '[Order] Place Order Request'
)
export const placeOrderSuccess=createAction(
  '[Order] Place Order Success', props<{payload: any}>()
)
export const placeOrderFailure= createAction(
  '[Order] Place Order Failure', props<{error: any}>()
)
export const shipOrderRequest=createAction(
  '[Order] Ship Order Request',
)
export const shipOrderSuccess=createAction(
  '[Order] Ship Order Success', props<{payload: any}>()
)
export const shipOrderFailure= createAction(
  '[Order] Ship Order Failure', props<{error: any}>()
)

export const deliveryOrderRequest=createAction(
  '[Order] Delivery Order Request'
)
export const deliveryOrderSuccess=createAction(
  '[Order] Delivery Order Success', props<{payload: any}>()
)
export const deliveryOrderFailure= createAction(
  '[Order] Delivery Order Failure', props<{error: any}>()
)
export const deleteOrderRequest=createAction(
  '[Order] Delete Order Request'
)
export const deleteOrderSuccess=createAction(
  '[Order] Delete Order Success', props<{payload: any}>()
)
export const deleteOrderFailure=createAction(
  '[Order] Delete Order Failure', props <{ error: any }>()
)
